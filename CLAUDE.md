...
**Pure vanilla JS, no framework or build system.** Three files:

- `index.html` — Shell with loading screen, header stats, globe container, side panel, tooltip
- `styles.css` — Dark theme, glassmorphism effects, responsive layout
